...
- `novo-APK-6-Setup-1.0.6.exe` → Windows
- `novo-APK-6-1.0.6.AppImage` → Linux
- `novo-APK-6-1.0.6.dmg` → Mac
...
- **Linux**: Execute `chmod +x novo-APK-6*.AppImage` antes de rodar.
